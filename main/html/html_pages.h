...
"    li { cursor: pointer; padding: 8px; border: 1px solid #ccc; margin-bottom: 4px; border-radius: 4px; }"
"    li.selected { background-color: #aaf; border-color: #88f; }"
"    button { padding: 8px 16px; margin-right: 10px; border-radius: 4px; border: none; cursor: pointer; }"
